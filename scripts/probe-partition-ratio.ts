...
console.log(`${'Label'.padEnd(24)} ${'ratio'.padStart(7)}  ${'λ'.padStart(7)}  ${'Ratio verdict'.padEnd(14)} λ verdict`);
console.log(`${'─'.repeat(90)}`);
...
for (const p of probes) {
  ...
  console.log(`${p.label.padEnd(24)} ${r.padStart(7)}  ${lambda.toFixed(2).padStart(7)}  ${ratioVerdict.padEnd(14)} ${lambdaVerdict}`);
}
console.log(`${'─'.repeat(90)}`);
